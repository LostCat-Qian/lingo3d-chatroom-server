...
// 注销用户
router.get('/delUser', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(req.query);
    try {
        yield userSchema_1.default.deleteOne({
            _id: req.query.id
        });
...
router.post('/updateUserInfo', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    try {
        yield userSchema_1.default.updateOne({
            _id: body._id
        }, {
...
router.post('/adminLogin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (adminInfo.username === body.username && adminInfo.password === body.password) {
        const token = (0, tokenUtil_1.createToken)(Object.assign({}, adminInfo));
        res.status(200).json(ResultJSON_1.default.SUCCESS({
            token
        }));
    }
